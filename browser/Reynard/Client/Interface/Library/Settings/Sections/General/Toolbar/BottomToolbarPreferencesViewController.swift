//
//  BottomToolbarPreferencesViewController.swift
//  Reynard
//
...
final class BottomToolbarPreferencesViewController: UITableViewController {
    ...
    private var includedActions = Prefs.ToolbarSettings.bottomToolbarActions
    ...
    override func viewDidLoad() {
        ...
        closeTabShortcutSwitch.isOn = Prefs.ToolbarSettings.closeTabLongPressOpensNewTab
        newTabShortcutSwitch.isOn = Prefs.ToolbarSettings.newTabLongPressClosesTab
        toolbarHapticsSwitch.isOn = Prefs.ToolbarSettings.toolbarButtonHapticsEnabled
    ...
    override func tableView(
        ...
        Prefs.ToolbarSettings.bottomToolbarActions = includedActions
    ...
    @objc private func closeTabShortcutChanged() {
        Prefs.ToolbarSettings.closeTabLongPressOpensNewTab = closeTabShortcutSwitch.isOn
        updateShortcutRow(0)
    }

    @objc private func newTabShortcutChanged() {
        Prefs.ToolbarSettings.newTabLongPressClosesTab = newTabShortcutSwitch.isOn
        updateShortcutRow(1)
    }

    @objc private func toolbarHapticsChanged() {
        Prefs.ToolbarSettings.toolbarButtonHapticsEnabled = toolbarHapticsSwitch.isOn
    }
    ...
    @objc private func resetToolbar() {
        ...
        Prefs.ToolbarSettings.toolbarButtonHapticsEnabled = true
        Prefs.ToolbarSettings.closeTabLongPressOpensNewTab = true
        Prefs.ToolbarSettings.newTabLongPressClosesTab = false
        UISelectionFeedbackGenerator().selectionChanged()
        persistAndReload()
    }
